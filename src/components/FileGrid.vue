<template>
  <div>
    <div class="file-section text-left" v-if="files && files.length">
      <h4 class="pl-3 pt-2">{{ $trans("files") }}</h4>
      <v-col cols="12">
              ...
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-overlay
                    absolute
                    color="#969696"
                    :value="item.is_official !== undefined && !item.is_official"
                  />
                  <v-chip
                    small
                    label
                  ...
                  <v-card-text>
                    <v-img :src="fileThumbnail(item)" alt="" />
                    <h4 class="text-truncate pt-3 file-name">
                      {{ item.name }}
                    </h4>
                  </v-card-text>
                </v-card>
